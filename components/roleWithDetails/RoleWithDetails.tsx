        ...
        <>
            <div className="bg-white py-8 md:py-10">
                <div className="flex flex-col mx-auto w-17/20 max-w-6xl">
                    <span className="font-semibold text-xl md:text-3xl truncate">{role.role}</span>
                    <span className="text-sm md:text-base mt-1.5 md:mt-2 mb-3.5 md:mb-4 truncate">{role.topics}</span>
                    <div className="flex gap-1 text-[10px] md:text-[12px] font-semibold">
                        <div className="min-w-0 truncate py-1.5 md:py-2 px-3.5 md:px-5 bg-foreground text-background rounded-full">
                            <span>Exp: {role.experience} {Number(role.experience) === 1 ? "yr" : "yrs"}</span>
                        </div>
                        <div className="min-w-0 truncate py-1.5 md:py-2 px-3.5 md:px-5 bg-foreground text-background rounded-full">
                            <span>{role.questions.length} Q&A</span>
                        </div>
                        <div className="min-w-0 truncate py-1.5 md:py-2 px-3.5 md:px-5 bg-foreground text-background rounded-full">
                            <span className="truncate">Last: {formatDateWithSuffix(role.updatedAt)}</span>
                        </div>
                    </div>
                </div>
            </div>
